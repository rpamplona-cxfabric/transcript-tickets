          ...
          >
            <div className="flex items-start justify-between gap-3">
              <div className="min-w-0">
                ...
                <p className="mt-1 line-clamp-2 text-xs lg:text-sm text-zinc-500 dark:text-zinc-400">
                  {t.description}
                </p>
              </div>
              <button
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              <div onClick={(e) => e.stopPropagation()}>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Select
                    value={t.status}
                    onChange={(val) =>
                      handleQuickUpdate(t, { status: val as any })
                    }
                    options={[
              ...
              <div onClick={(e) => e.stopPropagation()}>
                ...
                <Select
                  value={t.priority}
                  onChange={(val) =>
                    handleQuickUpdate(t, { priority: val as any })
                  }
                  options={[
                    { value: "low", label: "Low" },
              ...
              >
                ...
                <td className="px-6 py-4 max-w-sm">
                  <div className="flex flex-col gap-0.5">
                    <span className="font-bold text-zinc-900 dark:text-zinc-100 group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors">
                      {t.title}
                    </span>
                    <span className="text-xs lg:text-sm text-zinc-500 dark:text-zinc-400 line-clamp-1">
                      {t.description}
                    </span>
                  </div>
                </td>
