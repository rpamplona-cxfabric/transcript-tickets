    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-start">
      {columns.map((col) => {
        ...
        return (
          <div
            key={col.id}
            className="app-surface rounded-2xl border border-zinc-200/80 p-4 dark:border-zinc-800 flex flex-col min-h-[400px]"
          >
              ...
              {columnTasks.map((t) => (
                ...
                >
                  ...
                  >
                    ...
                    >
                      <span
                        className={`h-1 w-1 rounded-full ${t.priority === "high" ? "bg-red-500" : "bg-zinc-400"}`}
                      />
                      {t.priority}
                    </span>
                  ...
                  <div
                    className="flex items-center justify-between border-t border-zinc-100 pt-3 dark:border-zinc-900/60"
                    onClick={(e) => e.stopPropagation()}
                  >
