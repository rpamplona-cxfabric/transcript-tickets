...
export const ConversationsLoadingSkeleton = () => (
  <div
    className="app-surface app-shadow-surface flex min-h-0 flex-1 flex-col overflow-hidden rounded-2xl border border-zinc-200 dark:border-zinc-800"
    role="status"
    ...
    <div className="table-scrollbar min-h-0 flex-1 overflow-y-auto">
      ...
      <div className="hidden overflow-x-auto lg:block">
        <table className="w-full border-collapse text-left text-sm">
          <TableHeader sticky>
            <tr>
              <SortableTableHeaderCell sortDirection={null}>
                DATE &amp; TIME
