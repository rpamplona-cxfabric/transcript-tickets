          ...
          <table className="w-full border-collapse text-left text-sm text-zinc-500 dark:text-zinc-400">
            <TableHeader sticky>
              <tr>
                <SortableTableHeaderCell
                  sortDirection={
                    sortField === "timestamp" ? sortDirection : null
                  }
                ...
                <SortableTableHeaderCell
                  sortDirection={sortField === "summary" ? sortDirection : null}
                  onSort={() => onSort("summary")}
                >
                  AI SUMMARY
                </SortableTableHeaderCell>
            ...
            <tbody className="divide-y divide-zinc-200 dark:divide-zinc-800">
              {transcripts.map((t) => (
                ...
                >
                  ...
                  >
                    <ActionMenu
                      ariaLabel={`Actions for conversation ${t.transcriptId}`}
                      actions={[
                        {
                          label: "View conversation",
                          onSelect: () => onSelectTranscript(t),
                        },
                      ]}
                    />
                  </td>
                ...
                {Array.from({ length: totalPages }, (_, i) => i + 1).map(
                  (page) => (
                    <button
                      ...
                      className={`inline-flex h-9 w-9 items-center justify-center rounded-full border text-sm font-normal transition-colors ${
                        currentPage === page
